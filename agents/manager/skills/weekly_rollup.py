...
class ManagerWeeklyRollupSkill:
    ...
    def execute(self, request: ManagerRollupRequest) -> str:
        ...
        system_prompt = (
            ...
            "     Use the 5 standard executive sections: Executive conclusion, Completed, In Progress, Blocked or At Risk, Important Changes, Requires Attention.\n"
            ...
            "3. Completed items: Must carry supporting citations and high-stakes quote: '- [Trainee Name] · [Deliverable Title]: [Details]. Quote: \"[Exact supporting quote]\" [Date, Page — Speaker]'\n"
            "4. In Progress items: '- [Trainee Name] · [Task Title]: [Current state & next step] [Date, Page — Speaker]'\n"
            "5. Blocked or At Risk: '- [Trainee Name] · [Impediment]: [Details]. Resolution State: [Agreed/Contested/Pending Decision] [Date, Page — Speaker]'\n"
            "6. Important Changes: '- [Topic]: [What architectural or tool shift occurred] [Date, Page — Speaker]'\n"
            "7. Requires Attention: '- [Issue]: [Recommended executive intervention point] [Date, Page — Speaker]'\n"
            ...
            "9. QUOTE QUALITY RULE: When selecting verbatim quotes, choose clear, technically meaningful statements. Avoid conversational stutters or filler words.\n"
            "10. Never invent facts or infer completion from absence of discussion.\n"
