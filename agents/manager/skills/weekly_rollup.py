...
class ManagerWeeklyRollupSkill:
    ...
    def execute(self, request: ManagerRollupRequest) -> str:
        ...
        user_prompt = (
            ...
            "[Synthesize a sharp 1-2 sentence takeaway, or adapt structure/depth to fulfill any specific query instructions]\n\n"
            "### **Completed**\n"
            "- [Trainee Name] · [Deliverable Title]: [Details]. Quote: \"[One exact supporting quote]\" [Date, Page — Speaker]\n\n"
            "### **In Progress**\n"
            "- [Trainee Name] · [Task Title]: [Current state & next step] [Date, Page — Speaker]\n\n"
            "### **Blocked or At Risk**\n"
            "- [Trainee Name] · [Impediment]: [Details]. Resolution State: [Agreed/Contested/Pending] [Date, Page — Speaker]\n\n"
            "### **Important Changes**\n"
            "- [Topic]: [What architectural or tool shift occurred] [Date, Page — Speaker]\n\n"
            "### **Requires Attention**\n"
            "- [Issue]: [Recommended executive intervention] [Date, Page — Speaker]"
        )
