...
def classify_intent(query: str, trainee_hint: Optional[str] = None) -> dict:
    ...
    system_prompt = (
        ...
        "- BROAD REPORT RULE: If the query asks for a general rollup, status, blocker report, or refers to 'all trainees', 'entire team', or the training program as a whole, set trainee=null to scope across the entire cohort.\n"
